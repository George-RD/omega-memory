...
EVAL_QUERIES: List[EvalQuery] = [
    ...
    # --- Temporal ---
    EvalQuery(
        query="what happened with element1 convergence",
        expected_keywords=["element1", "convergence", "orchestrator", "conductor"],
        description="Temporal/project: Element1 convergence",
    ),
